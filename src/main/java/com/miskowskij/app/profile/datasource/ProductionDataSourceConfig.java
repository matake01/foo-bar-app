...
public class ProductionDataSourceConfig implements DataSourceConfig {
	...
	private final static org.slf4j.Logger logger = LoggerFactory.getLogger(ProductionDataSourceConfig.class);
	...
	@Override
    public void setup() {
    	logger.info("Setting up DataSource config for PRODUCTION environment");
